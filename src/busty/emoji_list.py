...
# Iterate through the list of unwanted emoji and remove each one from the global list.
DISCORD_TO_UNICODE = ORIGINAL_DISCORD_TO_UNICODE.copy()
for removed_emoji in emoji_to_remove:
    try:
